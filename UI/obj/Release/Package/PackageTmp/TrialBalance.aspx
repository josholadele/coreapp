<%@ Page Title="" Language="C#" MasterPageFile="~/UI.Master" AutoEventWireup="true" CodeBehind="TrialBalance.aspx.cs" Inherits="UI.TrialBalance" %>
 ...
 <div class="panel panel-default">
                                ...
                                <div class="dataTables_wrapper no-footer">
                                       ...
                                       <asp:GridView ID="balancetable" CssClass="table datatable_simple dataTable no-footer" OnRowDataBound="balancetable_OnRowDataBound" runat="server" AutoGenerateColumns = "false" Height="409px" Width="797px">
                                            ...
                                            <Columns>
                                            <asp:BoundField DataField="Name" HeaderStyle-BackColor="#33414e" HeaderStyle-ForeColor="#ffffff" HeaderText = "Account Title" />
